                    ...
                    <div class="card card-primary card-outline">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <a href="{{ route('admin.dynamic_page'). '?language=' . $dynamicpage->language->code }}" class="btn btn-primary btn-sm">
                            ...
                            <div class="card-body">
                                <form class="form-horizontal" action="{{ route('admin.dynamic_page.update',  $dynamicpage->id) }}" method="POST">
                                    @csrf
                                    <input type="hidden" name="language" value="{{ $dynamicpage->language->code }}">
