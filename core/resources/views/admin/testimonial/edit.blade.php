                    ...
                    <div class="card">
                            <div class="card-header  card-primary card-outline">
                                ...
                                <div class="card-tools">
                                    <a href="{{ route('admin.testimonial'). '?language=' . $testimonial->language->code }}" class="btn btn-primary btn-sm">
                            ...
                            <!-- /.card-header -->
                            <div class="card-body">
                                <form class="form-horizontal" action="{{ route('admin.update_testimonial', $testimonial->id) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <input type="hidden" name="language" value="{{ $testimonial->language->code }}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea class="form-control summernote" name="message" placeholder="{{ __('Message') }}" " rows="5">{{ $testimonial->message }}</textarea>
