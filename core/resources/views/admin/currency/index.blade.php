                ...
                <div class="card card-primary card-outline">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <a href="{{ route('admin.add_currency') }}" class="btn btn-primary btn-sm">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('admin.edit_currency', $curr->id) }}" class="btn btn-info btn-sm"><i class="fas fa-pencil-alt"></i>{{ __('Edit') }}</a>

                                    @else
                                    <a href="{{ route('admin.update_currencystatus', $curr->id ) }}" class="btn btn-primary btn-sm">{{ __('Set Default') }}</a>
                                    <a href="{{ route('admin.edit_currency', $curr->id) }}" class="btn btn-info btn-sm"><i class="fas fa-pencil-alt"></i>{{ __('Edit') }}</a>

                                    <form  id="deleteform" class="d-inline-block" action="{{ route('admin.delete_currency', $curr->id ) }}" method="post">
                                        @csrf
