        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card card-primary card-outline">
                    ...
                    <div class="card-body">
                        <form class="form-horizontal" action="{{ route('admin.setting.update_basicinfo', $basicinfo->language_id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
            ...
            <div class="col-md-12">
                <div class="card card-primary card-outline">
                    ...
                    <!-- /.box-header -->
                    <div class="card-body">
                        <form class="form-horizontal" action="{{ route('admin.setting.update_commoninfo') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group row">
