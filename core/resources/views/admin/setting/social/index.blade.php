            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            <form id="slink" class="form-horizontal" action="{{ route('admin.store_slinks') }}" method="POST" onsubmit="store(event)" >
                                @csrf
                                    ...
                                    <tbody>
                                        @foreach ($socials as $id => $social)
                                            <tr>
                                                ...
                                                <td>{{ $social->url }}</td>
                                                <td>
                                                    <a class="btn btn-primary btn-sm" href="{{ route('admin.edit_slinks',$social->id) }}">
                                                        <i class="fas fa-pencil-alt"></i>{{ __('Edit') }}
                                                    </a>
                                                    <form id="deleteform" class="deleteform d-inline-block" action="{{ route('admin.delete_slinks', $social->id) }}"
                                                        method="post">
                                                        @csrf
