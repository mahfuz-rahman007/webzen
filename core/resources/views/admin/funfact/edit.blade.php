            ...
            <div class="col-lg-12">
                    <div class="card card-primary card-outline">
                            <div class="card-header  with-border">
                                ...
                                <a href="{{ route('admin.funfact'). '?language=' . $funfact->language->code }}" class="btn btn-primary btn-sm">
                            ...
                            <!-- /.card-header -->
                            <div class="card-body">
                                    <form   id="slink" class="form-horizontal" action="{{ route('admin.update_funfact', $funfact->id) }}" method="POST" enctype="multipart/form-data"   onsubmit="store(event)">
                                        @csrf

                                        <input type="hidden" name="language" value="{{ $funfact->language->code }}">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <button class="btn btn-secondary biconpicker" data-iconset="fontawesome5" data-icon="{{ $funfact->icon }}" role="iconpicker"></button>
