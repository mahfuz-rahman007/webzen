                    ...
                    <div class="card card-primary card-outline">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <a href="{{ route('admin.service'). '?language=' . $service->language->code }}" class="btn btn-primary btn-sm">
                            ...
                            <!-- /.card-header -->
                            <div class="card-body">
                                <form  id="slink" class="form-horizontal" action="{{ route('admin.update_service',  $service->id) }}" method="POST" enctype="multipart/form-data"  onsubmit="store(event)">
                                    @csrf
                                    <input type="hidden" name="language" value="{{ $service->language->code }}">
                                    ...
                                    <div class="form-group row">
                                        <label for="" class="col-sm-2 control-label">{{ __('Service Icon') }}<span
                                        class="text-danger">*</span></label>

                                        <div class="col-sm-10">
                                            <button class="btn btn-secondary biconpicker" data-iconset="fontawesome5" data-icon="{{ $service->icon }}" role="iconpicker"></button>
