        ...
        <div class="card card-primary card-outline">
          <div class="card-header">
            ...
            <div class="card-tools">
              <a href="{{ route('admin.service'). '?language=' . request()->input('language') }}" class="btn btn-primary btn-sm">
          ...
          <!-- /.card-header -->
          <div class="card-body">
            <form id="slink" class="form-horizontal" action="{{ route('admin.store_service') }}" method="POST"  onsubmit="store(event)"
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <select class="form-control lang" name="language_id">
                    ...
                    <option value="{{$lang->id}}" {{ $lang->code == request()->input('language') ? 'selected' : '' }}>{{$lang->name}}
                    </option>
                    @endforeach
                  </select>
