        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card card-primary card-outline">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form class="form-horizontal" action="{{ route('admin.update_servicecontent',  $sectiontitle->language_id) }}" method="POST">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="service_title" placeholder="{{ __('Service Title') }}" value="{{ $sectiontitle->service_title }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="service_subtitle" placeholder="{{ __('Service Sub-Title') }}" value="{{ $sectiontitle->service_subtitle }}">
                ...
                <div class="card card-primary card-outline">
                    <div class="card-header">
                        ...
                        <div class="card-tools d-flex">
                            ...
                            <a href="{{ route('admin.add_service'). '?language=' . request()->input('language') }}" class="btn btn-primary btn-sm">
                    ...
                    <table class="table table-striped table-bordered data_table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('admin.edit_service', $service->id) }}" class="btn btn-info btn-sm"><i class="fas fa-pencil-alt"></i>{{ __('Edit') }}</a>
                                    <form  id="deleteform" class="d-inline-block" action="{{ route('admin.delete_service', $service->id ) }}" method="post">
                                        @csrf
