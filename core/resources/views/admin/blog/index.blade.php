        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card card-primary card-outline">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form class="form-horizontal" action="{{ route('admin.update_blogcontent',  $sectiontitle->language_id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="blog_title" placeholder="{{ __('Blog Title') }}" value="{{ $sectiontitle->blog_title }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="blog_subtitle" placeholder="{{ __('Blog Sub-Title') }}" value="{{ $sectiontitle->blog_subtitle }}">
            ...
            <div class="col-md-12">
                <div class="card card-primary card-outline">
                    ...
                    <div class="card-tools d-flex">
                        ...
                        <a href="{{ route('admin.add_blog'). '?language=' .request()->input('language') }}" class="btn btn-primary btn-sm">
                    ...
                    <table id="idtable" class="table table-bordered table-striped data_table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('admin.edit_blog', $blog->id) }}" class="btn btn-info btn-sm"><i class="fas fa-pencil-alt"></i>{{ __('Edit') }}</a>
                                    <form  id="deleteform" class="d-inline-block" action="{{ route('admin.delete_blog', $blog->id ) }}" method="post">
                                        @csrf
