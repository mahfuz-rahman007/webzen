                    ...
                    <div class="card card-primary card-outline">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <a href="{{ route('admin.blog'). '?language=' . request()->input('language') }}" class="btn btn-primary btn-sm">
                            ...
                            <!-- /.card-header -->
                            <div class="card-body">
                                <form class="form-horizontal" action="{{ route('admin.store_blog') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
