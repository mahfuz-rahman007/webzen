        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card card-primary card-outline">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form class="form-horizontal" action="{{ route('admin.update_plancontent',  $sectiontitle->language_id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="plan_title" placeholder="{{ __('Pakage Title') }}" value="{{ $sectiontitle->plan_title }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="plan_subtitle" placeholder="{{ __('Pakage Sub-Title') }}" value="{{ $sectiontitle->plan_subtitle }}">
                ...
                <div class="card card-primary card-outline">
                    <div class="card-header">
                        ...
                        <div class="card-tools d-flex">
                            ...
                            <a href="{{ route('admin.add_package'). '?language=' . request()->input('language') }}" class="btn btn-primary btn-sm">
                    ...
                    <table class="table table-striped table-bordered data_table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('admin.edit_package', $package->id) }}" class="btn btn-info btn-sm"><i class="fas fa-pencil-alt"></i>{{ __('Edit') }}</a>
                                    <form  id="deleteform" class="d-inline-block" action="{{ route('admin.delete_package', $package->id ) }}" method="post">
                                        @csrf
